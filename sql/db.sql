...
insert into vt.`vt_setting` values('settingFreePointMs','300');
insert into vt.`vt_setting` values('settingInPointHotKey','a');
insert into vt.`vt_setting` values('settingSpeedPointHotKey','s');
